# 🛑 PROIECT DEZACTIVAT DEFINITIV & ARHIVAT

> [!WARNING]
> **Dezvoltarea, mentenanța și rularea live a acestei platforme au fost oprite definitiv la data de 29 Iunie 2026.**
>
> Această decizie a fost luată în urma solicitării oficiale transmise în scris de către Serviciul de Comunicații și Tehnologia Informației (SCTI) al Universității „Ștefan cel Mare” din Suceava. Universitatea a izolat sistemele legacy de gestiune a școlarității (PeopleSoft / `scolaritate.usv.ro`) într-un spațiu privat neaccesibil din exterior și lucrează la implementarea propriei platforme numite „Smart UMS”.
> 
> Acest repository este marcat ca **arhivă istorică (Read-Only)** și este păstrat public exclusiv ca portofoliu personal și **Proof of Concept (PoC) open-source** de succes care a deservit **peste 40.000 de vizitatori unici (identificați la nivel de IP și dispozitiv conform Cloudflare)** și a procesat **peste 3,1 milioane de cereri HTTP** în doar o lună de funcționare (cu vârfuri de peste 3.700 de utilizatori activi zilnic). Versiunea rulată pe domeniul `noteusv.tech` a fost oprită local, servind acum doar o pagină statică permanentă de atenționare, orice interogare sau conexiune activă spre sistemele universității fiind complet eliminată.
...
**[→ noteusv.tech](https://noteusv.tech)** — dezactivat definitiv, servește doar pagina de notificare.
